...
function appendNewCardTest() {
  ...
  if (card.children.length !== 2) {
    console.error(`${ERROR} card div should have 2 children, got ${flipContainer.children.length}. The card-container should have a div with the class card-down and another div with the class card-up.`);
    return false;
  }
